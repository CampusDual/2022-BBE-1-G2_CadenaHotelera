...
insert  into client (cli_name,cli_surname1,cli_surname2,cli_identification,cli_phone,cli_email) values ('Mario', 'PEREZ','MARTINEZ','76545454Y','667788990','jp@mail.net');
...
insert  into client (cli_name,cli_surname1,cli_surname2,cli_identification,cli_phone,cli_email) values ('Miguel', 'JUAREZ','LOPEZ','3444455556P','22334433','juan.m@mail.co.uk');
...
values(1,'2022-06-25',1,120,true),
      (1,'2022-06-26',1,120,true),
      (1,'2022-06-27',1,120,true),
      (1,'2022-06-28',1,120,true),
...
values(2,'2022-06-27',1,120,true),
      (2,'2022-06-28',1,120,true),
      (2,'2022-06-29',1,120,true),
      (2,'2022-06-30',1,120,true),
      (2,'2022-07-01',1,120,true),
      (2,'2022-07-02',1,120,true);
...
insert into booking_details(bok_det_bok_id,bok_det_date,bok_det_type,bok_det_price,bok_det_paid)
values(3,'2022-07-03',1,120,true);
...
insert into booking_details(bok_det_bok_id,bok_det_date,bok_det_type,bok_det_price,bok_det_paid)
values(4,'2022-07-03',1,120,true),
      (4,'2022-07-04',1,120,true),
      (4,'2022-07-05',1,120,true),
...
values(5,'2022-06-28',1,120,true),
      (5,'2022-06-29',1,120,true),
      (5,'2022-06-30',1,120,true),
      (5,'2022-07-01',1,120,true),
      (5,'2022-07-02',1,120,true),
      (5,'2022-07-03',1,120,true),
      (5,'2022-07-04',1,120,true),
      (5,'2022-07-05',1,120,true),
      (5,'2022-07-06',1,120,true);
...
insert into booking_details(bok_det_bok_id,bok_det_date,bok_det_type,bok_det_price,bok_det_paid)
values(6,'2022-07-05',1,120,true),
      (6,'2022-07-06',1,120,true);

insert into booking (bok_cli_id,bok_htl_id,bok_rom_number,bok_entry_date,bok_departure_date,bok_status_code,bok_comments)
values (1,1,'103','2022-07-19','2022-07-25','F','comments');

insert into booking_details(bok_det_bok_id,bok_det_date,bok_det_type,bok_det_price,bok_det_paid)
values(7,'2022-07-19',1,120,true),
      (7,'2022-07-20',1,120,true),
      (7,'2022-07-21',1,120,true),
      (7,'2022-07-22',1,120,true),
      (7,'2022-07-23',1,120,true),
      (7,'2022-07-24',1,120,true);
...
insert into booking_details(bok_det_bok_id,bok_det_date,bok_det_type,bok_det_price,bok_det_paid)
values(9,'2022-06-19',1,120,true),
      (9,'2022-06-20',1,120,true),
      (9,'2022-06-21',1,120,true),
      (9,'2022-06-22',1,120,true),
      (9,'2022-06-23',1,120,true),
      (9,'2022-06-24',1,120,true),
      (9,'2022-06-25',1,120,true),
      (9,'2022-06-26',1,120,true),
      (9,'2022-06-27',1,120,true),
      (9,'2022-06-28',1,120,true),
      (9,'2022-06-29',1,120,true),
      (9,'2022-06-30',1,120,true),
      (9,'2022-07-01',1,120,true),
      (9,'2022-07-02',1,120,true),
      (9,'2022-07-02',1,120,true),
      (9,'2022-07-03',1,120,true),
      (9,'2022-07-04',1,120,true),
      (9,'2022-07-05',1,120,true),
      (9,'2022-07-06',1,120,true),
      (9,'2022-07-07',1,120,true),
      (9,'2022-07-08',1,120,true),
      (9,'2022-07-09',1,120,true),
      (9,'2022-07-10',1,120,true),
      (9,'2022-07-11',1,120,true),
      (9,'2022-07-12',1,120,true),
      (9,'2022-07-13',1,120,true),
      (9,'2022-07-14',1,120,true);
...
insert into booking_details(bok_det_bok_id,bok_det_date,bok_det_type,bok_det_price,bok_det_paid)
values(10,'2022-06-29',1,350,true),
      (10,'2022-06-30',1,350,true),
      (10,'2022-07-01',1,350,true);
...
insert into employee(emp_etyp_id,emp_name,emp_surname1,emp_surname2,emp_bank_account, emp_identification,emp_email,emp_phone,emp_htl_id,emp_usr_user)
values('1','Mario','Perico','Palotes','ES 92 5555 6666 7777 6666','11223345J','mario-perico@Yahoo.es','666555445','1','mario');
insert into employee(emp_etyp_id,emp_name,emp_surname1,emp_surname2,emp_bank_account, emp_identification,emp_email,emp_phone,emp_htl_id,emp_usr_user)
values('1','Miguel','Perico','Palotes','ES 92 5555 6666 7777 7777','11223346J','miguel-perico@Yahoo.es','666555446','1','miguel');
insert into employee(emp_etyp_id,emp_name,emp_surname1,emp_surname2,emp_bank_account, emp_identification,emp_email,emp_phone,emp_htl_id,emp_usr_user)
values('1','Carlos','Perico','Palotes','ES 92 5555 6666 7777 8888','11223347J','carlos-perico@Yahoo.es','666555447','1','carlos');

--prueba de horario de empleado--
insert into employee_schedule(emp_sch_emp_id,emp_sch_day,emp_sch_turn_in,emp_sch_turn_out)
values(1,'2022-07-26','8:00','14:00');
